...
func render_index(w io.Writer, key string, states map[string]string, newStates map[string]any) {
	...
	w.Write([]byte(" <h2 style=\"margin-top:2rem\"><a href=\"https://github.com/gnituy18/tmplx/blob/main/tmplx.org/todo.html\">Source Code:</a></h2> <pre> <code tx-ignore=\"\" class=\"language-html\">&lt;script type=&#34;text/tmplx&#34;&gt;\n        var list []string = []string{}\n        var item string = &#34;&#34;\n\n        func add() {\n        list = append(list, item)\n        item = &#34;&#34;\n        }\n\n        func remove(i int) {\n        list = append(list[0:i], list[i+1:]...)\n        }\n        &lt;/script&gt;\n\n        &lt;label&gt;New &lt;input type=&#34;text&#34; tx-value=&#34;item&#34;&gt;&lt;/label&gt;\n        &lt;button tx-onclick=&#34;add()&#34;&gt;Add&lt;/button&gt;\n        &lt;ol&gt;\n        &lt;li tx-for=&#34;i, l := range list&#34; tx-key=&#34;l&#34; tx-onclick=&#34;remove(i)&#34;&gt;\n        { l }\n        &lt;/li&gt;\n        &lt;/ol&gt;</code> </pre> <p>It allows you to build UIs with React-like reactivity purely in Go.</p> <h2 style=\"margin-top:2rem\"><a href=\"https://github.com/gnituy18/tmplx/blob/main/tmplx.org/tmplx/handler.html\">Compiled Code:</a></h2> </main> </body></html>"))
}
