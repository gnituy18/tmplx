...
func tx_new_tx_H_callback(tx_prev url.Values, tx_next map[string]any, tx_trigger string, tx_trigger_handler string, tx_id string, tx_target string) *tx_H_callback {
	tx_comp := &tx_H_callback{}
	tx_comp.tx_target = tx_target
	tx_comp.tx_prev = tx_prev
	tx_comp.tx_next = tx_next
	tx_comp.tx_trigger = tx_trigger
...
func (tx_comp *tx_H_callback) add() {
	tx_comp.V_total++
}

func (tx_comp *tx_H_callback) tx_compute(tx_id string) {
	{
		tx_id := tx_id + ":tx-incbtn-1"
		tx_val_label := "press me"
		tx_child := tx_new_tx_H_incbtn(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_comp.tx_target, &tx_val_label, tx_comp.add)
		tx_child.tx_compute(tx_id)
		tx_comp.tx_next[tx_id] = tx_child
	}
}

func (tx_comp *tx_H_callback) tx_render(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString("<!--tx:")
	fmt.Fprint(tx_w, tx_id)
	...
	{
		tx_id := tx_id + ":tx-incbtn-1"
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_incbtn)
...
func tx_new_tx_H_condrows(tx_prev url.Values, tx_next map[string]any, tx_trigger string, tx_trigger_handler string, tx_id string, tx_target string) *tx_H_condrows {
	tx_comp := &tx_H_condrows{}
	tx_comp.tx_target = tx_target
	tx_comp.tx_prev = tx_prev
	tx_comp.tx_next = tx_next
	tx_comp.tx_trigger = tx_trigger
...
func (tx_comp *tx_H_condrows) tx_render(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString("<!--tx:")
	fmt.Fprint(tx_w, tx_id)
	tx_w.WriteString("--> <ul> ")
...
func tx_new_tx_H_derived(tx_prev url.Values, tx_next map[string]any, tx_trigger string, tx_trigger_handler string, tx_id string, tx_target string) *tx_H_derived {
	tx_comp := &tx_H_derived{}
	tx_comp.tx_target = tx_target
	tx_comp.tx_prev = tx_prev
	tx_comp.tx_next = tx_next
	tx_comp.tx_trigger = tx_trigger
...
func (tx_comp *tx_H_derived) tx_eh1() {
	tx_comp.V_count++
	tx_comp.V_doubled = tx_comp.V_count * 2
}

func (tx_comp *tx_H_derived) tx_compute(tx_id string) {
	if tx_id == tx_comp.tx_trigger {
		switch tx_comp.tx_trigger_handler {
		case "eh1":
			tx_comp.tx_eh1()
...
func (tx_comp *tx_H_derived) tx_render(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString("<!--tx:")
	fmt.Fprint(tx_w, tx_id)
	...
	tx_w.WriteString("\" data-tx-target=\"")
	fmt.Fprint(tx_w, tx_comp.tx_target)
	tx_w.WriteString("\" data-tx-eh1-on=\"click\">increment</button> <!--tx:")
	fmt.Fprint(tx_w, tx_id+"_e")
	tx_w.WriteString("-->")
}
...
func tx_new_tx_H_incbtn(tx_prev url.Values, tx_next map[string]any, tx_trigger string, tx_trigger_handler string, tx_id string, tx_target string, label *string, onpress func()) *tx_H_incbtn {
	tx_comp := &tx_H_incbtn{}
	tx_comp.tx_target = tx_target
	tx_comp.tx_prev = tx_prev
	tx_comp.tx_next = tx_next
...
func (tx_comp *tx_H_incbtn) tx_eh1() {
	tx_comp.V_onpress()
}

func (tx_comp *tx_H_incbtn) tx_compute(tx_id string) {
	if tx_id == tx_comp.tx_trigger {
		switch tx_comp.tx_trigger_handler {
		case "eh1":
			tx_comp.tx_eh1()
...
func (tx_comp *tx_H_incbtn) tx_render(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString("<!--tx:")
	fmt.Fprint(tx_w, tx_id)
	tx_w.WriteString("--> <button data-tx-trigger=\"")
	fmt.Fprint(tx_w, tx_id)
...
func tx_new_tx_H_inputlive(tx_prev url.Values, tx_next map[string]any, tx_trigger string, tx_trigger_handler string, tx_id string, tx_target string) *tx_H_inputlive {
	tx_comp := &tx_H_inputlive{}
	tx_comp.tx_target = tx_target
	tx_comp.tx_prev = tx_prev
	tx_comp.tx_next = tx_next
	tx_comp.tx_trigger = tx_trigger
...
func (tx_comp *tx_H_inputlive) tx_eh1(tx_ev_target_value string) {
	tx_comp.V_inputValue = tx_ev_target_value
}

func (tx_comp *tx_H_inputlive) tx_compute(tx_id string) {
	if tx_id == tx_comp.tx_trigger {
		switch tx_comp.tx_trigger_handler {
		case "eh1":
...
func (tx_comp *tx_H_inputlive) tx_render(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString("<!--tx:")
	fmt.Fprint(tx_w, tx_id)
	...
	tx_w.WriteString(" chars)</p> <!--tx:")
	fmt.Fprint(tx_w, tx_id+"_e")
	tx_w.WriteString("-->")
}

type tx_H_nav struct {
	tx_target          string         `json:"-"`
	tx_prev            url.Values     `json:"-"`
	tx_next            map[string]any `json:"-"`
	tx_trigger         string         `json:"-"`
...
func tx_new_tx_H_nav(tx_prev url.Values, tx_next map[string]any, tx_trigger string, tx_trigger_handler string, tx_id string, tx_target string) *tx_H_nav {
	tx_comp := &tx_H_nav{}
	tx_comp.tx_target = tx_target
	tx_comp.tx_prev = tx_prev
	tx_comp.tx_next = tx_next
...
func (tx_comp *tx_H_nav) tx_render(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString("<!--tx:")
	fmt.Fprint(tx_w, tx_id)
	tx_w.WriteString("--><header class=\"bar\"> <a class=\"bar-brand\" href=\"/\"> <img src=\"/logo.svg\" alt=\"\" width=\"28\" height=\"28\"/> tmplx </a> <nav class=\"bar-links\"> <a href=\"/docs\">Docs</a> <a href=\"/playground\">Playground</a> <a href=\"https://github.com/gnituy18/tmplx\">GitHub</a> </nav> </header> <!--tx:")
	fmt.Fprint(tx_w, tx_id+"_e")
	tx_w.WriteString("-->")
}

type tx_H_props struct {
	tx_target          string         `json:"-"`
	tx_prev            url.Values     `json:"-"`
	tx_next            map[string]any `json:"-"`
	tx_trigger         string         `json:"-"`
...
func tx_new_tx_H_props(tx_prev url.Values, tx_next map[string]any, tx_trigger string, tx_trigger_handler string, tx_id string, tx_target string) *tx_H_props {
	tx_comp := &tx_H_props{}
	tx_comp.tx_target = tx_target
	tx_comp.tx_prev = tx_prev
	tx_comp.tx_next = tx_next
...
func (tx_comp *tx_H_props) tx_eh1() {
	tx_comp.V_clicks++
	tx_comp.V_doubled = tx_comp.V_clicks * 2
}

func (tx_comp *tx_H_props) tx_compute(tx_id string) {
	if tx_id == tx_comp.tx_trigger {
		switch tx_comp.tx_trigger_handler {
		case "eh1":
			tx_comp.tx_eh1()
	...
	}
	{
		...
		tx_val_label := "Clicks"
		tx_child := tx_new_tx_H_stat(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_comp.tx_target, &tx_val_label, &tx_comp.V_clicks)
		tx_comp.tx_next[tx_id] = tx_child
	}
	{
		tx_id := tx_id + ":tx-stat-2"
		tx_val_label := "Doubled"
		tx_child := tx_new_tx_H_stat(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_comp.tx_target, &tx_val_label, &tx_comp.V_doubled)
		tx_comp.tx_next[tx_id] = tx_child
	}
}

func (tx_comp *tx_H_props) tx_render(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString("<!--tx:")
	fmt.Fprint(tx_w, tx_id)
	tx_w.WriteString("--> <p>")
	{
	...
	tx_w.WriteString("\" data-tx-target=\"")
	fmt.Fprint(tx_w, tx_comp.tx_target)
	tx_w.WriteString("\" data-tx-eh1-on=\"click\">click</button> <!--tx:")
	fmt.Fprint(tx_w, tx_id+"_e")
	tx_w.WriteString("-->")
}

type tx_H_slotcard struct {
	tx_target          string         `json:"-"`
	tx_prev            url.Values     `json:"-"`
	tx_next            map[string]any `json:"-"`
	tx_trigger         string         `json:"-"`
...
func tx_new_tx_H_slotcard(tx_prev url.Values, tx_next map[string]any, tx_trigger string, tx_trigger_handler string, tx_id string, tx_target string, title *string) *tx_H_slotcard {
	tx_comp := &tx_H_slotcard{}
	tx_comp.tx_target = tx_target
	tx_comp.tx_prev = tx_prev
	tx_comp.tx_next = tx_next
	tx_comp.tx_trigger = tx_trigger
...
func (tx_comp *tx_H_slotcard) tx_render(tx_w *bytes.Buffer, tx_id string, tx_render_fill_ func()) {
	tx_w.WriteString("<!--tx:")
	fmt.Fprint(tx_w, tx_id)
...
func tx_new_tx_H_slotdemo(tx_prev url.Values, tx_next map[string]any, tx_trigger string, tx_trigger_handler string, tx_id string, tx_target string) *tx_H_slotdemo {
	tx_comp := &tx_H_slotdemo{}
	tx_comp.tx_target = tx_target
	tx_comp.tx_prev = tx_prev
	tx_comp.tx_next = tx_next
	tx_comp.tx_trigger = tx_trigger
...
func (tx_comp *tx_H_slotdemo) tx_compute(tx_id string) {
	{
		tx_id := tx_id + ":tx-slotcard-1"
		tx_val_title := "Card title"
		tx_child := tx_new_tx_H_slotcard(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_comp.tx_target, &tx_val_title)
		tx_comp.tx_next[tx_id] = tx_child
	}
}

func (tx_comp *tx_H_slotdemo) tx_render(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString("<!--tx:")
	fmt.Fprint(tx_w, tx_id)
	tx_w.WriteString("-->")
	{
		tx_id := tx_id + ":tx-slotcard-1"
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_slotcard)
		tx_child.tx_render(tx_w, tx_id, func() {
			tx_comp.tx_render_fill_tx_H_slotcard_1_(tx_w)
		})
	}
	tx_w.WriteString(" <!--tx:")
	fmt.Fprint(tx_w, tx_id+"_e")
...
func (tx_comp *tx_H_slotdemo) tx_render_fill_tx_H_slotcard_1_(tx_w *bytes.Buffer) {
...
func tx_new_tx_H_types(tx_prev url.Values, tx_next map[string]any, tx_trigger string, tx_trigger_handler string, tx_id string, tx_target string) *tx_H_types {
	tx_comp := &tx_H_types{}
	tx_comp.tx_target = tx_target
	tx_comp.tx_prev = tx_prev
	tx_comp.tx_next = tx_next
...
func (tx_comp *tx_H_types) tx_eh1() {
	tx_comp.V_count++
}

func (tx_comp *tx_H_types) tx_compute(tx_id string) {
	if tx_id == tx_comp.tx_trigger {
		switch tx_comp.tx_trigger_handler {
		case "eh1":
			tx_comp.tx_eh1()
...
func (tx_comp *tx_H_types) tx_render(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString("<!--tx:")
	fmt.Fprint(tx_w, tx_id)
	...
	tx_w.WriteString("\" data-tx-target=\"")
	fmt.Fprint(tx_w, tx_comp.tx_target)
	tx_w.WriteString("\" data-tx-eh1-on=\"click\">count++</button> <!--tx:")
	fmt.Fprint(tx_w, tx_id+"_e")
	tx_w.WriteString("-->")
}
...
func (tx_comp *tx_S_docs) tx_compute() {
	{
		tx_id := "tx-nav-1"
		tx_child := tx_new_tx_H_nav(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_id)
		tx_comp.tx_next[tx_id] = tx_child
	}
	{
	...
	}
	{
		...
		tx_comp.tx_next[tx_id] = tx_child
		{
			...
			tx_child := tx_new_tx_H_types(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_id)
			tx_child.tx_compute(tx_id)
			tx_comp.tx_next[tx_id] = tx_child
		}
	}
	{
		...
		tx_comp.tx_next[tx_id] = tx_child
		{
			...
			tx_child := tx_new_tx_H_derived(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_id)
			tx_child.tx_compute(tx_id)
			tx_comp.tx_next[tx_id] = tx_child
		}
	}
	...
	}
	{
		...
		tx_comp.tx_next[tx_id] = tx_child
		{
			...
			tx_child := tx_new_tx_H_inputlive(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_id)
			tx_child.tx_compute(tx_id)
			tx_comp.tx_next[tx_id] = tx_child
		}
	}
	...
	}
	{
		...
		tx_comp.tx_next[tx_id] = tx_child
		{
			...
			tx_child := tx_new_tx_H_condrows(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_id)
			tx_comp.tx_next[tx_id] = tx_child
		}
	}
	{
	...
	}
	{
		...
		tx_comp.tx_next[tx_id] = tx_child
		{
			...
			tx_child := tx_new_tx_H_props(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_id)
			tx_child.tx_compute(tx_id)
			tx_comp.tx_next[tx_id] = tx_child
		}
	}
	{
		...
		tx_comp.tx_next[tx_id] = tx_child
		{
			...
			tx_child := tx_new_tx_H_callback(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_id)
			tx_child.tx_compute(tx_id)
			tx_comp.tx_next[tx_id] = tx_child
		}
	}
	{
		...
		tx_comp.tx_next[tx_id] = tx_child
		{
			...
			tx_child := tx_new_tx_H_slotdemo(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_id)
			tx_child.tx_compute(tx_id)
			tx_comp.tx_next[tx_id] = tx_child
		}
	}
...
func (tx_comp *tx_S_docs) tx_render(tx_w1 *bytes.Buffer, tx_w2 *bytes.Buffer) {
	...
	tx_w2.WriteString(" <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">counter.html</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"counter\"></div> </div> <p> Both buttons mutate <code>counter</code> inline and the span re-renders with the new value. Any valid Go statement works in the body—here a compound assignment doubles a value on each click: </p> ")
	{
		tx_id := "tx-example-wrapper-5"
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_example_H_wrapper)
		tx_child.tx_render(tx_w2, tx_id, func() {
	...
	tx_w2.WriteString(" <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">cond.html</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"cond\"></div> </div> <p> You can declare <strong>local variables</strong> and handle errors exactly as you would in regular Go code. Local variables declared in conditionals are available to the element and its descendants, just like in Go. </p> <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">html</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"docs-32\"></div> </div> <p> A conditional group consists of <strong>consecutive sibling nodes</strong> that share the same parent. Disconnected nodes are not treated as part of the same group. A standalone <code>tx-else-if</code> or <code>tx-else</code> without a preceding <code>tx-if</code> will cause a compilation error. </p> <h3 id=\"loops\">Loops</h3> <p> To repeat elements, use the <code>tx-for</code> attribute. Its value can be any valid Go <code>for</code> statement, including <strong>classic for</strong> or <strong>range for</strong>. </p> <p> Local variables declared in the loop are available to the element and all of its descendants, just like in Go. </p> <p> Always add a <code>tx-key</code> attribute with a unique value for each item. This gives the compiler a unique identifier for the node during updates. </p> ")
	{
		...
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_example_H_wrapper)
		tx_child.tx_render(tx_w2, tx_id, func() {
			tx_comp.tx_render_fill_tx_H_example_H_wrapper_10_(tx_w2, tx_id)
		})
	}
	tx_w2.WriteString(" <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">triangle.html</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"triangle\"></div> </div> <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">html</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"docs-34\"></div> </div> <p> To branch per item, do <strong>not</strong> put <code>tx-if</code> and <code>tx-for</code> on the same element—the condition is compiled outside the loop and cannot see the loop variable, which is a compile error. Put the conditional on an element <strong>inside</strong> the loop so it can read the bound variable: </p> ")
	{
		...
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_example_H_wrapper)
		tx_child.tx_render(tx_w2, tx_id, func() {
			tx_comp.tx_render_fill_tx_H_example_H_wrapper_11_(tx_w2, tx_id)
		})
	}
	...
	tx_w2.WriteString(" <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">stat.html (the component)</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"stat\"></div> </div> <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">props.html (using it)</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"props\"></div> </div> <h4 id=\"callback-props\">Callback Props</h4> <p> A <strong>callback prop</strong> lets a child notify the parent when something happens. It is just a prop whose type is a <strong>function</strong>: declare it with <code>//tx:prop</code> and a function type. With no default the parent <strong>must</strong> supply an implementation (a required prop); give it a function-literal default to make the parent override optional. </p> <p>In the child, call it from a handler the same way you call a function:</p> <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">tmplx</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"docs-40\"></div> </div> <p> In the parent, pass the <strong>bare name</strong> of a tmplx-script function as the attribute whose key matches the child&#39;s prop name: </p> <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">tmplx</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"docs-41\"></div> </div> <p> When the child calls <code>onselect(42)</code>, the parent&#39;s <code>pick</code> runs on the server with that argument and the parent re-renders. A callback call can be mixed freely with other statements in the same handler—for example <code>tx-onclick=&#34;count++; onselect(42)&#34;</code>. </p> <p> To make the override optional, give the prop a function-literal default. The parent may then omit the attribute and the child falls back to its own implementation: </p> <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">tmplx</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"docs-42\"></div> </div> <p> A runnable version: <code>&lt;tx-incbtn&gt;</code> takes a <code>label</code> and an <code>onpress</code> callback; the parent passes its own <code>add</code> function and counts the presses. </p> ")
	{
		...
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_example_H_wrapper)
		tx_child.tx_render(tx_w2, tx_id, func() {
			tx_comp.tx_render_fill_tx_H_example_H_wrapper_14_(tx_w2, tx_id)
		})
	}
	tx_w2.WriteString(" <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">incbtn.html (the component)</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"incbtn\"></div> </div> <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">callback.html (using it)</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"callback\"></div> </div> <h3 id=\"slot\">&lt;slot&gt;</h3> <p> A <code>&lt;slot&gt;</code> marks a place in a component&#39;s template where the parent can inject content. Slots are how components stay composable: the child decides the shape, the parent fills in the details. </p> <h4>Declaring slots in a component</h4> <p> Each slot is either the <strong>default slot</strong> (no <code>name</code>) or a <strong>named slot</strong>. A component may have at most one default slot, and named slots must be unique. Slots cannot be nested inside other slots. </p> <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">html</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"docs-43\"></div> </div> <p> Content placed inside <code>&lt;slot&gt;...&lt;/slot&gt;</code> is <strong>fallback content</strong>—it renders only when the parent does not fill that slot. </p> <h4>Filling slots from the parent</h4> <p> Put fill content directly inside the component tag. Use the <code>slot</code> attribute on a child element to target a named slot; everything else becomes the default fill. </p> <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">html</span> <div class=\"snippet-actions\"><button class=\"copy-btn\" type=\"button\">copy</button></div> </div> <div class=\"snippet-code\" data-snippet=\"docs-44\"></div> </div> <p> Only the <strong>direct children</strong> of the component tag are considered when matching slots—a <code>slot</code> attribute on a deeply nested element has no effect. </p> ")
	{
		...
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_example_H_wrapper)
		tx_child.tx_render(tx_w2, tx_id, func() {
			tx_comp.tx_render_fill_tx_H_example_H_wrapper_15_(tx_w2, tx_id)
		})
	}
...
func (tx_comp *tx_S_docs) tx_render_fill_tx_H_example_H_wrapper_10_(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString(" ")
	{
		tx_id := tx_id + "@tx-triangle-1"
...
func (tx_comp *tx_S_docs) tx_render_fill_tx_H_example_H_wrapper_11_(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString(" ")
	{
		tx_id := tx_id + "@tx-condrows-1"
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_condrows)
		tx_child.tx_render(tx_w, tx_id)
	}
	tx_w.WriteString(" ")
}

func (tx_comp *tx_S_docs) tx_render_fill_tx_H_example_H_wrapper_12_(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString(" ")
	{
		tx_id := tx_id + "@tx-greeting-1"
...
func (tx_comp *tx_S_docs) tx_render_fill_tx_H_example_H_wrapper_13_(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString(" ")
	{
		tx_id := tx_id + "@tx-props-1"
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_props)
		tx_child.tx_render(tx_w, tx_id)
	}
	tx_w.WriteString(" ")
}

func (tx_comp *tx_S_docs) tx_render_fill_tx_H_example_H_wrapper_14_(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString(" ")
	{
		tx_id := tx_id + "@tx-callback-1"
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_callback)
		tx_child.tx_render(tx_w, tx_id)
	}
	tx_w.WriteString(" ")
}

func (tx_comp *tx_S_docs) tx_render_fill_tx_H_example_H_wrapper_15_(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString(" ")
	{
		tx_id := tx_id + "@tx-slotdemo-1"
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_slotdemo)
		tx_child.tx_render(tx_w, tx_id)
	}
	tx_w.WriteString(" ")
}
...
func (tx_comp *tx_S_docs) tx_render_fill_tx_H_example_H_wrapper_2_(tx_w *bytes.Buffer, tx_id string) {
	...
	{
		tx_id := tx_id + "@tx-types-1"
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_types)
		tx_child.tx_render(tx_w, tx_id)
	}
	tx_w.WriteString(" ")
}
...
func (tx_comp *tx_S_docs) tx_render_fill_tx_H_example_H_wrapper_3_(tx_w *bytes.Buffer, tx_id string) {
	...
	{
		tx_id := tx_id + "@tx-derived-1"
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_derived)
		tx_child.tx_render(tx_w, tx_id)
	}
	tx_w.WriteString(" ")
}
...
func (tx_comp *tx_S_docs) tx_render_fill_tx_H_example_H_wrapper_6_(tx_w *bytes.Buffer, tx_id string) {
	...
	{
		tx_id := tx_id + "@tx-inputlive-1"
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_inputlive)
		tx_child.tx_render(tx_w, tx_id)
	}
	tx_w.WriteString(" ")
}
...
func (tx_comp *tx_S_docs) tx_render_fill_tx_H_example_H_wrapper_8_(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString(" ")
	{
		tx_id := tx_id + "@tx-current-time-1"
...
func (tx_comp *tx_S_docs) tx_render_fill_tx_H_example_H_wrapper_9_(tx_w *bytes.Buffer, tx_id string) {
	tx_w.WriteString(" ")
	{
		tx_id := tx_id + "@tx-cond-1"
...
type tx_S_hello_S__L_name_R_ struct {
	tx_prev            url.Values     `json:"-"`
	tx_next            map[string]any `json:"-"`
	tx_trigger         string         `json:"-"`
	tx_trigger_handler string         `json:"-"`
...
func tx_new_tx_S_hello_S__L_name_R_(tx_prev url.Values, tx_next map[string]any, tx_trigger string, tx_trigger_handler string, name string) *tx_S_hello_S__L_name_R_ {
	tx_comp := &tx_S_hello_S__L_name_R_{}
	tx_comp.tx_prev = tx_prev
	tx_comp.tx_next = tx_next
	tx_comp.tx_trigger = tx_trigger
	tx_comp.tx_trigger_handler = tx_trigger_handler
...
func (tx_comp *tx_S_hello_S__L_name_R_) tx_compute() {
	{
		tx_id := "tx-nav-1"
		tx_child := tx_new_tx_H_nav(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_id)
		tx_comp.tx_next[tx_id] = tx_child
...
func (tx_comp *tx_S_hello_S__L_name_R_) tx_render(tx_w1 *bytes.Buffer, tx_w2 *bytes.Buffer) {
...
func (tx_comp *tx_S__EX_) tx_render(tx_w1 *bytes.Buffer, tx_w2 *bytes.Buffer) {
	tx_w1.WriteString("<!-- prettier-ignore --><!DOCTYPE html><html lang=\"en\"><head> <title>tmplx</title> <link rel=\"icon\" type=\"image/svg+xml\" href=\"/logo.svg\"/> <meta charset=\"UTF-8\"/> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"/> <link rel=\"stylesheet\" href=\"https://cdn.jsdelivr.net/npm/modern-normalize@3.0.1/modern-normalize.min.css\"/> <link rel=\"stylesheet\" href=\"/style.css\"/> <link rel=\"stylesheet\" href=\"/snippets.css\"/> <script type=\"application/json\" id=\"tx-saved\" data-tx-page=\"/{$}\">")
	tx_w2.WriteString("</script><script id=\"tx-runtime\">")
	fmt.Fprint(tx_w2, tx_runtime_script)
	tx_w2.WriteString("</script></head> <body> ")
	{
	...
	tx_w2.WriteString(" <main> <div style=\"display:flex;align-items:center;justify-content:center\"> <img src=\"/logo.svg\" alt=\"tmplx logo\" width=\"96\" height=\"96\"/> <h1 style=\"text-align: center\">tmplx</h1> </div> <h2 style=\"text-align: center; margin-top: 1.5rem\"> Write Go in HTML intuitively </h2> <ul style=\"margin-top: 4rem\"> <li>Full Go backend logic and HTML in the same file</li> <li>Reactive UIs driven by plain Go variables</li> <li>Reusable components written as regular HTML files</li> </ul> <div style=\"\n          display: flex;\n          flex-wrap: wrap;\n          gap: 2rem;\n          justify-content: center;\n          text-align: center;\n          margin-top: 4rem;\n        \"> <a class=\"btn\" href=\"/docs\">Docs</a> <a class=\"btn\" href=\"/playground\">Playground</a> <a class=\"btn\" href=\"https://github.com/gnituy18/tmplx\">GitHub</a> </div> <h2 style=\"text-align: center\">Demos</h2> <h3>Counter</h3> ")
	{
		tx_id := "tx-example-wrapper-1"
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_example_H_wrapper)
		tx_child.tx_render(tx_w2, tx_id, func() {
	...
	tx_w2.WriteString(" <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">counter.html</span> <div class=\"snippet-actions\"> <a href=\"https://github.com/gnituy18/tmplx/blob/master/tmplx.org/components/counter.html\" target=\"_blank\" rel=\"noopener\">source</a> <button class=\"copy-btn\" type=\"button\">copy</button> </div> </div> <div class=\"snippet-code\" data-snippet=\"counter\"></div> </div> <h3>To Do</h3> ")
	{
		tx_id := "tx-example-wrapper-2"
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_example_H_wrapper)
		tx_child.tx_render(tx_w2, tx_id, func() {
	...
	tx_w2.WriteString(" <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">todo.html</span> <div class=\"snippet-actions\"> <a href=\"https://github.com/gnituy18/tmplx/blob/master/tmplx.org/components/todo.html\" target=\"_blank\" rel=\"noopener\">source</a> <button class=\"copy-btn\" type=\"button\">copy</button> </div> </div> <div class=\"snippet-code\" data-snippet=\"todo\"></div> </div> <h3>Triangle</h3> ")
	{
		tx_id := "tx-example-wrapper-3"
		tx_child := tx_comp.tx_next[tx_id].(*tx_H_example_H_wrapper)
		tx_child.tx_render(tx_w2, tx_id, func() {
	...
	tx_w2.WriteString(" <div class=\"snippet\"> <div class=\"snippet-bar\"><span class=\"snippet-name\">triangle.html</span> <div class=\"snippet-actions\"> <a href=\"https://github.com/gnituy18/tmplx/blob/master/tmplx.org/components/triangle.html\" target=\"_blank\" rel=\"noopener\">source</a> <button class=\"copy-btn\" type=\"button\">copy</button> </div> </div> <div class=\"snippet-code\" data-snippet=\"triangle\"></div> </div> </main> <script src=\"/snippets.js\"></script> </body></html>")
}
...
func tx_new_tx_S_playground(tx_prev url.Values, tx_next map[string]any, tx_trigger string, tx_trigger_handler string) *tx_S_playground {
	tx_comp := &tx_S_playground{}
	tx_comp.tx_prev = tx_prev
	tx_comp.tx_next = tx_next
	tx_comp.tx_trigger = tx_trigger
	tx_comp.tx_trigger_handler = tx_trigger_handler
...
func (tx_comp *tx_S_playground) tx_compute() {
	{
		tx_id := "tx-nav-1"
		tx_child := tx_new_tx_H_nav(tx_comp.tx_prev, tx_comp.tx_next, tx_comp.tx_trigger, tx_comp.tx_trigger_handler, tx_id, tx_id)
		tx_comp.tx_next[tx_id] = tx_child
...
func (tx_comp *tx_S_playground) tx_render(tx_w1 *bytes.Buffer, tx_w2 *bytes.Buffer) {
	...
	tx_w2.WriteString(" <main class=\"pg-main\"> <h1 style=\"text-align: center\">Playground</h1> <p style=\"text-align: center; color: var(--muted)\"> Write a tmplx page (HTML + a <code>&lt;script type=&#34;text/tmplx&#34;&gt;</code> block) and see the Go that tmplx compiles it to. </p> <div class=\"pg-bar\"> <button id=\"compile\" class=\"btn-compile\" type=\"button\">Compile</button> <span class=\"note\">Compiles on the server (type-checks only, never runs your code). Standard-library imports only.</span> </div> <div class=\"pg-wrap\"> <div class=\"pg-col\"> <h3>tmplx source</h3> <textarea id=\"src\" spellcheck=\"false\">&lt;!DOCTYPE html&gt;\n&lt;html&gt;\n&lt;head&gt;\n  &lt;title&gt;Counter&lt;/title&gt;\n  &lt;script type=&#34;text/tmplx&#34;&gt;\n    var counter int\n  &lt;/script&gt;\n&lt;/head&gt;\n&lt;body&gt;\n  &lt;button tx-onclick=&#34;counter--&#34;&gt;-&lt;/button&gt;\n  &lt;span&gt;{ counter }&lt;/span&gt;\n  &lt;button tx-onclick=&#34;counter++&#34;&gt;+&lt;/button&gt;\n&lt;/body&gt;\n&lt;/html&gt;</textarea> </div> <div class=\"pg-col\"> <h3>generated Go (routes.go)</h3> <div id=\"out\"></div> <pre id=\"errors\" class=\"pg-errors\" style=\"display: none\"></pre> </div> </div> </main> <script>\n    (function () {\n      var inCM = CodeMirror.fromTextArea(document.getElementById(\"src\"), {\n        mode: { name: \"htmlmixed\", scriptTypes: [{ matches: /text\\/tmplx/, mode: \"go\" }] },\n        theme: \"material-darker\",\n        lineNumbers: true,\n        tabSize: 2,\n        indentUnit: 2,\n        lineWrapping: false,\n      });\n      inCM.setSize(\"100%\", \"30rem\");\n\n      var outCM = CodeMirror(document.getElementById(\"out\"), {\n        mode: \"go\",\n        theme: \"material-darker\",\n        lineNumbers: true,\n        readOnly: true,\n        value: \"\",\n      });\n      outCM.setSize(\"100%\", \"30rem\");\n\n      var outEl = document.getElementById(\"out\");\n      var errEl = document.getElementById(\"errors\");\n      var btn = document.getElementById(\"compile\");\n\n      function showCode(code) {\n        errEl.style.display = \"none\";\n        outEl.style.display = \"\";\n        outCM.setValue(code);\n        outCM.refresh();\n      }\n      function showErrors(lines) {\n        outEl.style.display = \"none\";\n        errEl.style.display = \"block\";\n        errEl.textContent = lines.join(\"\\n\");\n      }\n\n      async function compile() {\n        var old = btn.textContent;\n        btn.textContent = \"Compiling...\";\n        btn.disabled = true;\n        try {\n          var res = await fetch(\"/playground/compile\", { method: \"POST\", body: inCM.getValue() });\n          var data = await res.json();\n          if (data.diagnostics && data.diagnostics.length) showErrors(data.diagnostics);\n          else showCode(data.code || \"\");\n        } catch (e) {\n          showErrors([\"request failed: \" + e]);\n        } finally {\n          btn.textContent = old;\n          btn.disabled = false;\n        }\n      }\n\n      btn.addEventListener(\"click\", compile);\n      compile();\n    })();\n  </script> </body></html>")
}
...
func tx_dispatch(tx_w http.ResponseWriter, tx_r *http.Request) {
	...
	case "/hello/{name}":
		var tx_buf1, tx_buf2 bytes.Buffer
		tx_comp := tx_new_tx_S_hello_S__L_name_R_(tx_prev, tx_next, tx_trigger, tx_trigger_handler, "")
		tx_next["page"] = tx_comp
		tx_comp.tx_compute()
		tx_comp.tx_render(&tx_buf1, &tx_buf2)
		tx_json, _ := json.Marshal(tx_next)
	...
	case "/playground":
		var tx_buf1, tx_buf2 bytes.Buffer
		tx_comp := tx_new_tx_S_playground(tx_prev, tx_next, tx_trigger, tx_trigger_handler)
		tx_next["page"] = tx_comp
		tx_comp.tx_compute()
		tx_comp.tx_render(&tx_buf1, &tx_buf2)
		tx_json, _ := json.Marshal(tx_next)
	...
	case "tx-callback":
		tx_comp := tx_new_tx_H_callback(tx_prev, tx_next, tx_trigger, tx_trigger_handler, tx_target, tx_target)
		tx_next[tx_target] = tx_comp
		tx_comp.tx_compute(tx_target)
		tx_comp.tx_render(&buf, tx_target)
	case "tx-cond":
		...
		tx_comp.tx_render(&buf, tx_target)
	case "tx-condrows":
		tx_comp := tx_new_tx_H_condrows(tx_prev, tx_next, tx_trigger, tx_trigger_handler, tx_target, tx_target)
		tx_next[tx_target] = tx_comp
		tx_comp.tx_render(&buf, tx_target)
	case "tx-counter":
	...
	case "tx-current-time":
		...
		tx_comp.tx_render(&buf, tx_target)
	case "tx-derived":
		tx_comp := tx_new_tx_H_derived(tx_prev, tx_next, tx_trigger, tx_trigger_handler, tx_target, tx_target)
		tx_next[tx_target] = tx_comp
		tx_comp.tx_compute(tx_target)
		tx_comp.tx_render(&buf, tx_target)
	case "tx-double":
	...
	case "tx-greeting":
		...
		tx_comp.tx_render(&buf, tx_target)
	case "tx-inputlive":
		tx_comp := tx_new_tx_H_inputlive(tx_prev, tx_next, tx_trigger, tx_trigger_handler, tx_target, tx_target)
		tx_next[tx_target] = tx_comp
		tx_comp.tx_compute(tx_target)
		tx_comp.tx_render(&buf, tx_target)
	case "tx-nav":
		tx_comp := tx_new_tx_H_nav(tx_prev, tx_next, tx_trigger, tx_trigger_handler, tx_target, tx_target)
		tx_next[tx_target] = tx_comp
		tx_comp.tx_render(&buf, tx_target)
	case "tx-props":
		tx_comp := tx_new_tx_H_props(tx_prev, tx_next, tx_trigger, tx_trigger_handler, tx_target, tx_target)
		tx_next[tx_target] = tx_comp
		tx_comp.tx_compute(tx_target)
		tx_comp.tx_render(&buf, tx_target)
	case "tx-slotdemo":
		tx_comp := tx_new_tx_H_slotdemo(tx_prev, tx_next, tx_trigger, tx_trigger_handler, tx_target, tx_target)
		tx_next[tx_target] = tx_comp
		tx_comp.tx_compute(tx_target)
		tx_comp.tx_render(&buf, tx_target)
	case "tx-todo":
	...
	case "tx-triangle":
		...
		tx_comp.tx_render(&buf, tx_target)
	case "tx-types":
		tx_comp := tx_new_tx_H_types(tx_prev, tx_next, tx_trigger, tx_trigger_handler, tx_target, tx_target)
		tx_next[tx_target] = tx_comp
		tx_comp.tx_compute(tx_target)
		tx_comp.tx_render(&buf, tx_target)
	default:
...
var tx_routes []TxRoute = []TxRoute{
	...
	},
	{
		...
		Handler: func(tx_w http.ResponseWriter, tx_r *http.Request) {
			tx_next := map[string]any{}
			tx_comp := tx_new_tx_S_hello_S__L_name_R_(nil, tx_next, "", "", tx_r.PathValue("name"))
			tx_next["page"] = tx_comp
			tx_comp.tx_compute()
			var tx_buf1, tx_buf2 bytes.Buffer
			tx_comp.tx_render(&tx_buf1, &tx_buf2)
	...
	},
	{
		...
		Handler: func(tx_w http.ResponseWriter, tx_r *http.Request) {
			tx_next := map[string]any{}
			tx_comp := tx_new_tx_S_playground(nil, tx_next, "", "")
			tx_next["page"] = tx_comp
			tx_comp.tx_compute()
			var tx_buf1, tx_buf2 bytes.Buffer
			tx_comp.tx_render(&tx_buf1, &tx_buf2)
